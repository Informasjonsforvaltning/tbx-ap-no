...
NB! #Standarden er utgått# - bruk RDF-basert tilgjengeliggjøring av begrepsbeskrivelser i stedet, se https://data.norge.no/specification/skos-ap-no-begrep/[_Forvaltningsstandard for tilgjengeliggjøring av begrepsbeskrivelser basert på SKOS (SKOS-AP-NO-Begrep)_].
