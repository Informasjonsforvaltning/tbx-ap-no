...
Standarden inngår i https://www.digdir.no/digitalisering-og-samordning/begrepsanalyse-og-definisjonsarbeid/1483[bruksområdet "Begrepsanalyse og definisjonsarbeid"] i _Referansekatalogen_.
