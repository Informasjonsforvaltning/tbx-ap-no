...
_Restriction 1: There shall be min. one `<langSec>` which contains a Definisjon (this `<descripGrp>`). In other words, every concept shall have min. one definition._
